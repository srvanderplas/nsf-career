...
Statistical graphics are one primary method scientists use to communicate results to the general public, but we have been arguing about best practices for the visual display of data almost since these graphical forms were created [@croxtonBarChartsCircle1927; @eellsRelativeMeritsCircles1926]. Different individuals and organizations have released guidelines for graphical design [@JointCommitteeStandards1915; @brewerGuidelinesUsePerceptual1994; @kosslynGraphDesignEye2006; @tufteVisualDisplayQuantitative2001], but many of these are based on aesthetic preferences, individual experience, or extrapolation from limited empirical studies.
<!-- on extremely simple graphics to a wide variety of modern graphics that . -->
