...
We examined these questions by testing charts with log and linear scales; in addition to a separate study testing each question above [@robinson_human_2022, additional publications in progress], we have also published a tool paper [@robinson_etal23] and a method validation paper [@robinson_etal22]. 
